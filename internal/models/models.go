...
const (
	Canceled RaceStatus = "Отменена"
	Booked   RaceStatus = "Забронирована"
	Closed   RaceStatus = "Завершена"
...
const (
	Canceled BookingStatus = "Отменен"
	Booked   BookingStatus = "Забронирован"
	Closed   BookingStatus = "Завершен"
)
